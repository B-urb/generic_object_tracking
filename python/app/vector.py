...
# SRC: https://gist.github.com/mcleonard/5351452
class Vector(object):
    ...
    def normalize(self, length=1.0):
        ...
        normed = tuple(length * x / norm for x in self)
    ...
    def __xor__(self, other):
        if len(self) != 3:
            raise ValueError("Cross product not defined for greater than 3D vector")
        else:
    ...
    def angleTo(self, other):
        return math.acos(self.clip(-1.0, self*other/(self.norm() * other.norm()),1.0))
